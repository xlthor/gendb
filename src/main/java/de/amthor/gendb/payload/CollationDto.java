...
public class CollationDto {
	...
	@JsonView({Views.Response.class, Views.TableUpdate.class, Views.TableCreate.class, Views.DatabaseCreate.class, Views.DatabaseUpdate.class, Views.DatabaseResponse.class})
	long collationid;
